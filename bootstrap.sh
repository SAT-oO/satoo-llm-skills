...
# Installs slash commands only. Skills are installed separately via /configure-skills.
...
echo "[+] Next step: run /configure-skills in Cursor Agent to install skills."
